...
public class DatabaseChangelog {
  ...
  public void insertBooks(BookRepository repository, AuthorRepository authorRepository,
    ...
    var pushkin = authorRepository.findById("1").block();
    var gogol = authorRepository.findById("3").block();
    var dostoevsky = authorRepository.findById("2").block();

    var roman = genreRepository.findById("1").block();
    var anime = genreRepository.findById("2").block();
    var detective = genreRepository.findById("3").block();
  ...
  public void insertComments(CommentRepository repository, BookRepository bookRepository) {
    var book1 = bookRepository.findById("1").block();
    var book2 = bookRepository.findById("2").block();
    var book3 = bookRepository.findById("3").block();
